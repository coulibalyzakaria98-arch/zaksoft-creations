...
function init(options) {
  ...
  client?.on("beforeSampling", ({ spanAttributes }, samplingDecision) => {
    if (
      ...
      typeof spanAttributes[SEMATTRS_HTTP_TARGET] === "string" && // eslint-disable-next-line deprecation/deprecation
      spanAttributes[SEMATTRS_HTTP_TARGET].includes("sentry_key") && // eslint-disable-next-line deprecation/deprecation
      spanAttributes[SEMATTRS_HTTP_TARGET].includes("sentry_client") || typeof spanAttributes[ATTR_URL_QUERY] === "string" && spanAttributes[ATTR_URL_QUERY].includes("sentry_key") && spanAttributes[ATTR_URL_QUERY].includes("sentry_client")
    ) {
