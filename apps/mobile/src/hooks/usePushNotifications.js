...
function usePushNotifications() {
    ...
    var registerForPushNotifications = function () { return __awaiter(_this, void 0, void 0, function () {
        var existingStatus, finalStatus, status_1, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, notifications_1.notificationService.registerDevice({
                            userId: user.id,
                            token: token.data,
                            platform: 'EXPO'
                        })];
    ...
    var handleNavigation = function (data) {
        ...
        switch (data.type) {
            case 'JOB_COMPLETED':
                expo_router_1.router.push('/(tabs)/design');
                break;
            case 'TEAM_INVITE':
                expo_router_1.router.push('/(tabs)/teams');
                break;
            default:
