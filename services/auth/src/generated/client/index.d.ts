...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'creditTransaction'
  ...
  interface CreditTransactionFieldRefs {
    ...
    readonly operation: FieldRef<"CreditTransaction", 'String'>
  ...
  export type CreditTransactionWhereInput = {
    ...
    operation?: StringFilter<"CreditTransaction"> | string
  ...
  export type CreditTransactionScalarWhereWithAggregatesInput = {
    ...
    operation?: StringWithAggregatesFilter<"CreditTransaction"> | string
