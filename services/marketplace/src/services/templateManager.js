...
var TemplateManager = /** @class */ (function () {
    ...
    TemplateManager.prototype.createTemplate = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var template;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.template.create({
                            data: {
                                name: data.name,
                    ...
                    case 1:
                        template = _a.sent();
                        if (!data.isPublic) return [3 /*break*/, 4];
    ...
    TemplateManager.prototype.getTemplate = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.template.findUnique({
                            where: { id: id },
                            include: {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma.template.update({
                                where: { id: id },
