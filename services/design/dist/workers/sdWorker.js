...
class SDWorker {
    ...
    async generateImage(jobId, prompt, options) {
        ...
        const response = await axios.post(`${REPLICATE_API}/predictions`, {
...
export const sdBridgeWorker = new Worker('image-generation', async (job) => {
