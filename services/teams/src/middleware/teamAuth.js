...
function teamAuth(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var teamId, userId, membership, error_1;
        var _a;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.membership.findUnique({
                            where: {
                                userId_teamId: { teamId: teamId, userId: userId }
                            },
                            include: { team: true }
                        })];
                case 2:
                    membership = _b.sent();
                    if (!membership) {
                        return [2 /*return*/, res.status(403).json({ error: 'You are not a member of this team' })];
                    }
