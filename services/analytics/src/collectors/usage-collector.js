...
var UsageCollector = /** @class */ (function () {
    function UsageCollector() {
    }
    UsageCollector.collectEvent = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var event, date;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.usageEvent.create({
                            data: {
                                userId: data.userId,
                                teamId: data.teamId,
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma.dailyUsage.upsert({
                                where: {
                                    userId_date_service: {
                                        userId: data.userId,
                                        date: date,
