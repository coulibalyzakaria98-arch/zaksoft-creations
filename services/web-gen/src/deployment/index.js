...
var DeploymentService = /** @class */ (function () {
    ...
    DeploymentService.prototype.deployWebsite = function (websiteId_1, platform_1) {
        return __awaiter(this, arguments, void 0, function (websiteId, platform, environment, config) {
            var website, deployment;
            if (environment === void 0) { environment = 'PRODUCTION'; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.prisma.website.findUnique({
                            where: { id: websiteId },
                            include: { user: true }
                        })];
                    case 1:
                        ...
                        return [4 /*yield*/, db_1.prisma.deployment.create({
                                data: {
                                    websiteId: websiteId,
                                    platform: platform,
                    ...
                    case 2:
                        deployment = _a.sent();
                        return [4 /*yield*/, db_1.deploymentQueue.add('deploy', {
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, { deploymentId: deployment.id }];
                }
            });
        });
    };
