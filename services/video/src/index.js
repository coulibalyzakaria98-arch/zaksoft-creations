...
var videoQueue = new bullmq_1.Queue('video-generation', {
    connection: redis,
    defaultJobOptions: {
        attempts: 2,
...
var CREDITS_COST = 5;
app.post('/video/generate', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, prompt_1, imageUrl, engine, options, userId, user, dbJob, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 4, , 5]);
                _a = req.body, prompt_1 = _a.prompt, imageUrl = _a.imageUrl, engine = _a.engine, options = _a.options;
                userId = (_b = req.user) === null || _b === void 0 ? void 0 : _b.userId;
                if (!prompt_1 && !imageUrl) {
                    return [2 /*return*/, res.status(400).json({ error: 'Prompt ou ImageUrl requis' })];
                }
                if (!userId) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.job.create({
                        data: {
                            ...
                            userId: userId,
                            status: 'PENDING',
                            input: { prompt: prompt_1, imageUrl: imageUrl, engine: engine, options: options },
            ...
            case 2:
                ...
                return [4 /*yield*/, videoQueue.add('generate', {
                        jobId: dbJob.id,
                        prompt: prompt_1,
                        imageUrl: imageUrl,
            ...
            case 4:
                error_1 = _c.sent();
                logging_1.default.error('Erreur vidéo generate:', { error: error_1 });
...
app.get('/video/status/:jobId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
                ...
                if (dbJob.status === 'COMPLETED') {
                    return [2 /*return*/, res.json({
                            id: dbJob.id,
                            status: 'completed',
                            url: ((_a = dbJob.video) === null || _a === void 0 ? void 0 : _a.videoUrl) || null
                        })];
                }
                ...
                return [4 /*yield*/, videoQueue.getJob(jobId)];
            case 2:
                bullJob = _b.sent();
                res.json({
                    id: dbJob.id,
...
app.listen(port, function () {
    logging_1.default.info('Video service started', { port: port });
});
